    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="name">Nama Anda</label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="{{ backpack_authentication_column() }}">Emel Anda</label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="password_confirmation">Sahkan Kata Laluan</label>
            ...
            @if (backpack_users_have_email() && config('backpack.base.setup_password_recovery_routes', true))
                <div class="text-center"><a href="{{ route('backpack.auth.password.reset') }}">Terlupa Kata Laluan?</a></div>
            @endif
            <div class="text-center"><a href="{{ route('backpack.auth.login') }}">Log Masuk</a></div>
        </div>
    </div>
@endsection
